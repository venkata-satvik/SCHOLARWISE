...
if(isset($_POST['delete'])) {
    ...
    ?> 
        <script>
            alert("Deleted a student record successfully!!");
        </script>
    <?php
...
if(isset($_POST['cancel'])) {
    ?> 
        <script>
            alert("No student records are being deleted");
        </script>
    <?php
    header('Location:remove_student.php');
}
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <div class="mt-3">
                          <h4><?php echo $_SESSION['stud_fname']; ?></h4>
                          <?php echo "Sem ".$_SESSION['stud_sem']." ".$_SESSION['stud_branch']." student"; ?>             
                  ...
                  <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary"><?php echo $_SESSION['stud_linkedin']; ?></span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github mr-2 icon-inline"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>Github</h6>
                        <span class="text-secondary"><?php echo $_SESSION['stud_github']; ?></span>
                      </li>
                    ...
                    <div class="card-body">
                      ...
                      <hr>
                       <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <?php echo $_SESSION['stud_sem'].$_SESSION['stud_section']; ?>             
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <?php echo $_SESSION['stud_contactnum']; ?>             
