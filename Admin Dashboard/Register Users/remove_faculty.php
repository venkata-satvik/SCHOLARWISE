...
session_start();
  ...
  if(isset($_POST['button'])) {
    ...
    $check_id = " select * from faculty where id = '$id' ";
    ...
    if($id_count === 1) {
      ...
      $_SESSION['fac_email'] = $user_data['email'];
      $_SESSION['fac_fname'] = $user_data['fullname'];
      $_SESSION['fac_idNum'] = $user_data['id'];
      $_SESSION['fac_name'] = strtok($_SESSION['fac_fname']," ");
      $_SESSION['fac_school'] = $user_data['school'];
      $_SESSION['fac_cc'] = $user_data['cc'];
      $_SESSION['fac_contactnum'] = $user_data['contact'];
      $_SESSION['fac_branch'] = $user_data['department'];
      $_SESSION['fac_linkedin'] = $user_data['linkedin'];
      $_SESSION['fac_github'] = $user_data['github'];

      header('Location:faculty_profile_delete.php');
            ...
            <div class="row gutters">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
                  <label for="idnum">Faculty ID Number</label>
                  <input
                    type="name"
