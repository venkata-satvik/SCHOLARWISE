...
session_start();
  ...
  include 'config.php';
        ...
        $email_id = " select * from faculty where email = '$email' ";
        ...
        if($email_count) {
          ...
          $_SESSION['fa_email'] = $user_data['email'];
          $_SESSION['fa_fname'] = $user_data['fullname'];
          $_SESSION['fa_name'] = strtok($_SESSION['fa_fname']," ");
          $_SESSION['fa_contactnum'] = $user_data['contact'];
          $_SESSION['fa_idNum'] = $user_data['id'];
          $_SESSION['fa_cc'] = $user_data['cc'];
          $_SESSION['fa_dept'] = $user_data['department'];
          $_SESSION['fa_school'] = $user_data['school'];
          $_SESSION['fa_linkedin'] = $user_data['linkedin'];
          $_SESSION['fa_github'] = $user_data['github'];

          if($pass_decode)
					{
						header("Location: faculty_dboard.php");
						die;
					}
          else {
